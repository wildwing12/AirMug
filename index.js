(() => {
    ...
    let enterNewsScene = false; //새로운 신이 시작되는 순간을 표시
            ...
            case 3:
                ...
                if(scrollRatio <values.rect1X[2].end){
                    ...
                    if(scrollRatio > values.canvas_scale[2].end && values.canvas_scale[2].end >0){
                        ...
                        values.canvasCaption_translateY[2].start = values.canvasCaption_opacity[2].end;
                        values.canvasCaption_translateY[2].end = values.canvasCaption_opacity[2].start;

                        objs.canvasCaption.style.opacity = calcValues(values.canvasCaption_opacity,currentYOffset);
                        objs.canvasCaption.style.transform = `translate3d(0,
                        ${calcValues(values.canvasCaption_translateY,currentYOffset)}%,0)`
                    }
                }
